...
String apiKey = "FXWDN5R8B8DB79I9";     //  Enter your Write API key from ThingSpeak

const char *ssid =  "hulk";     // replace with your wifi ssid and wpa2 key
const char *pass =  "happy77111";
...
void setup() 
{
 ...
 // Serial.println("----------------------BUILDING VIBRATION demo------------------------");
